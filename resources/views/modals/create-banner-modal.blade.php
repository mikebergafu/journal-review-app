    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frm-submit-add-new-banner" role="form" method="POST"
                      action="{{route('banner.slider.store')}}" enctype="multipart/form-data" >
                    @csrf
                    <div class="form-group">
                        <label for="banner_title" class="control-label">Title</label>
                        <div>
                            <textarea class="form-control input-lg" id="banner_title"
                                      name="banner_title">{{old('banner_title')}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="banner_message" class="control-label">Details</label>
                        <div>
                            <textarea class="form-control input-lg" rows="6" id="banner_message"
                                      name="banner_message">{{old('banner_message')}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="file" class="form-control input-lg"
                                   accept="image/x-png,image/jpg,image/jpeg,image/png" id="banner_image"
                                   name="banner_image"
                                   data-min-width="1920"
